/*
 * multi_heap_4.h (completion for heap_4.c / h)
 *
...
#ifdef HEAP_0
static uint8_t HEAP_0;
#endif
#ifdef HEAP_1
static uint8_t HEAP_1;
#endif
#ifdef HEAP_2
static uint8_t HEAP_2;
#endif
#ifdef HEAP_3
static uint8_t HEAP_3;
#endif
#ifdef HEAP_4
static uint8_t HEAP_4;
#endif
#ifdef HEAP_5
static uint8_t HEAP_5;
#endif
...
{
  return multiPortMalloc(0, xWantedSize);
}
