...
void showStats()
{
  ...
  if(optim == 0)
  {
    ...
    BSP_LCD_DisplayStringAt(0, SCR_HT - 28, (uint8_t *)txt, LEFT_MODE);
    snprintf(txt, 30, "%d-%d ms  %d-%d fps   ", msMin, msMax, 1000 / msMax, 1000 / msMin);
    BSP_LCD_SetTextColor(LCD_COLOR_GREEN);
    BSP_LCD_DisplayStringAt(0, SCR_HT - 18, (uint8_t *)txt, LEFT_MODE);
  ...
  else
  {
    ...
    BSP_LCD_DisplayStringAt(10 * 6, SCR_HT - 28, (uint8_t *)txt, LEFT_MODE);
    snprintf(txt, 30,"%2d-%2d", msMin, msMax);
    BSP_LCD_SetTextColor(LCD_COLOR_GREEN);
    BSP_LCD_DisplayStringAt(0, SCR_HT - 18, (uint8_t *)txt, LEFT_MODE);
    snprintf(txt, 30, "%2d-%2d", 1000 / msMax, 1000 / msMin);
    BSP_LCD_DisplayStringAt(10 * 6, SCR_HT - 18, (uint8_t *)txt, LEFT_MODE);
